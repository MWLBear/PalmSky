...
EVENT_TEMPLATES = [
    ...
    # ✨ 新增：道具模板 (15% 概率)
    {
        ...
        "weight": 15,
        "desc_suffix": " 似有宝光。",
        "choice_a_logic": "grant_item", # 获得护身符
        "choice_b_logic": "nothing"
    }
]
...
def build_effect(logic_type, qi_base, stage_idx):
    ...
    if logic_type == "grant_item":
        # value 设为 None (在 Swift 里是 Optional)
...
for i in range(TOTAL_EVENTS):
    ...
    if target_stage_idx >= 10: weights = [40, 40, 20, 10] # 后期道具稀有
    else: weights = [50, 25, 10, 15] # 前期道具多一点，防身
